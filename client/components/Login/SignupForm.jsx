...
import {BrowserRouter as Redirect, Router, Switch, Route, Link, useHistory} from 'react-router-dom';
...
const SignupForm = () => {
  ...
  const {handleChange, vals, handleSubmit, errors, history} = useSignUp(validate);
